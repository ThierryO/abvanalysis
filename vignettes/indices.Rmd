...
vignette: >
  ...
  %\VignetteIndexEntry{Weging van de indices volgens stratum}
...
- De kans op aanwezigheid in een hok per stratum blijft niet noodzakelijk constant. Met welke frequentie berekenen we dit? Een aantal mogelijkheden zijn jaarlijks, per cyclus, over meerdere cycli, ... De huidige situatie is als volgt:
    ...
    Indices per cyclus
      ~ Kans op aanwezigheid wordt per cyclus berekend. Strata zonder waarnemingen in de volledige cyclus worden genegeerd voor die cyclus. Deze situatie komtveel minder frequent voor dan bij de jaarlijkse indices
